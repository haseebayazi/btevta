...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Edit OEP</h2>
            <p class="text-gray-600 mt-1">Update information for {{ $oep->name }}</p>
        </div>
    ...
    <form action="{{ route('admin.oeps.update', $oep->id) }}" method="POST" class="bg-white rounded-lg shadow-sm p-6 space-y-6">
        @csrf @method('PUT')
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="name" id="name" required
                           ...
                           value="{{ old('name', $oep->name) }}" placeholder="e.g., Al-Hamd Overseas">
                    @error('name')
                ...
                <div>
                    ...
                    <input type="text" name="code" id="code" required
                           ...
                           value="{{ old('code', $oep->code) }}" placeholder="e.g., OEP-001">
                    @error('code')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="company_name" id="company_name"
                           ...
                           value="{{ old('company_name', $oep->company_name) }}" placeholder="Registered company name">
                    @error('company_name')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="registration_number" id="registration_number"
                           ...
                           value="{{ old('registration_number', $oep->registration_number) }}" placeholder="Government registration no.">
                ...
                <div>
                    ...
                    <input type="url" name="website" id="website"
                           ...
                           value="{{ old('website', $oep->website) }}" placeholder="https://example.com">
                    @error('website')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="country" id="country" required
                           ...
                           value="{{ old('country', $oep->country) }}" placeholder="e.g., Saudi Arabia">
                    @error('country')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="city" id="city"
                           ...
                           value="{{ old('city', $oep->city) }}" placeholder="e.g., Riyadh">
                    @error('city')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="contact_person" id="contact_person" required
                           ...
                           value="{{ old('contact_person', $oep->contact_person) }}" placeholder="Primary contact name">
                ...
                <div>
                    ...
                    <input type="tel" name="phone" id="phone" required
                           ...
                           value="{{ old('phone', $oep->phone) }}" placeholder="e.g., +966 50 123 4567">
                    @error('phone')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" required
                           ...
                           value="{{ old('email', $oep->email) }}" placeholder="contact@oep.com">
                    @error('email')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div>
            ...
            <textarea name="address" id="address" rows="3"
                      ...
                      placeholder="Full business address...">{{ old('address', $oep->address) }}</textarea>
        </div>
        ...
        <div class="flex justify-between items-center pt-4 border-t border-gray-200">
            ...
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 flex items-center">
                <i class="fas fa-save mr-2"></i>Update OEP
            </button>
        </div>
    </form>
</div>

...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Create New Campus</h2>
            <p class="text-gray-600 mt-1">Add a new campus location to the system</p>
        </div>
    ...
    <form action="{{ route('admin.campuses.store') }}" method="POST" class="bg-white rounded-lg shadow-sm p-6 space-y-6">
        @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" required
                           ...
                           value="{{ old('name') }}" placeholder="e.g., Lahore Campus">
                    @error('name')
                ...
                <div>
                    ...
                    <input type="text" name="location" id="location" required
                           ...
                           value="{{ old('location') }}" placeholder="e.g., Gulberg, Lahore">
                    @error('location')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="province" id="province" required
                           ...
                           value="{{ old('province') }}" placeholder="e.g., Punjab">
                    @error('province')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="contact_person" id="contact_person" required
                           ...
                           value="{{ old('contact_person') }}" placeholder="Name of campus coordinator">
                ...
                <div>
                    ...
                    <textarea name="address" id="address" rows="3"
                              ...
                              placeholder="Complete campus address...">{{ old('address') }}</textarea>
                </div>
            </div>
        </div>

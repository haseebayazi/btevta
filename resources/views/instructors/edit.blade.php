@extends('layouts.app')
@section('title', 'Edit – ' . $instructor->name)
@section('content')
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-gray-500 text-sm mt-0.5">{{ $instructor->name }}</p>
            </div>
        </div>
        <a href="{{ route('instructors.show', $instructor) }}"
            ...
            <div class="p-6 grid md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" id="cnic" name="cnic"
                           value="{{ old('cnic', $instructor->cnic) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="address" name="address" rows="2"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none">{{ old('address', $instructor->address) }}</textarea>
                </div>
            </div>
        </div>

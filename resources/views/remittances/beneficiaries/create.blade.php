...
@section('title', 'Add Beneficiary - ' . config('app.name'))
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Add Beneficiary</h1>
            <p class="text-gray-600 mt-1">Add a remittance receiver for {{ $candidate->full_name }}</p>
        </div>
    ...
    <!-- Form -->
    <form action="{{ route('beneficiaries.store', $candidate->id) }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Primary beneficiary will be selected by default in remittance forms</p>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="2"
                              ...
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
                    @error('address')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="mobile_wallet" value="{{ old('mobile_wallet') }}"
        ...
        <div class="flex items-center justify-end space-x-3">
            ...
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg">
                <i class="fas fa-save mr-2"></i>Add Beneficiary
            </button>
        </div>
    </form>

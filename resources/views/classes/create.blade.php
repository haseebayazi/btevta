...
@section('title', 'Create Training Class')

@section('content')
<div class="container mx-auto px-4 py-6 max-w-4xl">
    <div class="mb-6">
        <h1 class="text-3xl font-bold">Create Training Class</h1>
        <p class="text-gray-600 mt-1">Set up a new training class for candidates</p>
    </div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="class_name" name="class_name" value="{{ old('class_name') }}"
                           class="form-input w-full @error('class_name') border-red-500 @enderror"
                           placeholder="e.g., Electrical Wiring Batch 2024-A" required>
                    @error('class_name')
                ...
                <div>
                    ...
                    <input type="text" id="class_code" name="class_code" value="{{ old('class_code') }}"
                ...
                <div>
                    ...
                    <input type="number" id="max_capacity" name="max_capacity" value="{{ old('max_capacity', 30) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="schedule" name="schedule" rows="2"
                              class="form-input w-full @error('schedule') border-red-500 @enderror"
                              placeholder="e.g., Monday to Friday, 9:00 AM - 1:00 PM">{{ old('schedule') }}</textarea>
                    @error('schedule')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>

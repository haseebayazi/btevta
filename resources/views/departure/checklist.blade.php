...
<div class="container mx-auto px-4 py-6 space-y-6">
    ...
    {{-- Info Note --}}
    <div class="bg-blue-50 border border-blue-200 text-blue-800 px-4 py-3 rounded-lg text-sm flex items-start gap-3">
        <i class="fas fa-info-circle mt-0.5 flex-shrink-0"></i>
        <span>PTN clearance and Protector clearance are managed in the <strong>Visa Processing</strong> stage. Complete them there before proceeding.</span>
    </div>

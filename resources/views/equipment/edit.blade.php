...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-1">Update equipment details: {{ $equipment->equipment_code }}</p>
        </div>
        ...
        <form action="{{ route('equipment.update', $equipment) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="campus_id" id="campus_id" class="form-select w-full @error('campus_id') border-red-500 @enderror" required>
                        ...
                        @foreach($campuses as $campus)
                            <option value="{{ $campus->id }}" {{ old('campus_id', $equipment->campus_id) == $campus->id ? 'selected' : '' }}>
                                {{ $campus->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $equipment->name) }}" class="form-input w-full @error('name') border-red-500 @enderror" required>
                    @error('name')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    <label for="equipment_code" class="block text-sm font-medium text-gray-700 mb-1">Equipment Code</label>
                    <input type="text" id="equipment_code" value="{{ $equipment->equipment_code }}" class="form-input w-full bg-gray-100" disabled>
                ...
                <div>
                    ...
                    <input type="number" name="quantity" id="quantity" value="{{ old('quantity', $equipment->quantity) }}" min="1" class="form-input w-full @error('quantity') border-red-500 @enderror" required>
                    @error('quantity')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="3" class="form-textarea w-full @error('description') border-red-500 @enderror">{{ old('description', $equipment->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="brand" id="brand" value="{{ old('brand', $equipment->brand) }}" class="form-input w-full @error('brand') border-red-500 @enderror">
                    @error('brand')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="model" id="model" value="{{ old('model', $equipment->model) }}" class="form-input w-full @error('model') border-red-500 @enderror">
                    @error('model')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="serial_number" id="serial_number" value="{{ old('serial_number', $equipment->serial_number) }}" class="form-input w-full @error('serial_number') border-red-500 @enderror">
                    @error('serial_number')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <select name="condition" id="condition" class="form-select w-full @error('condition') border-red-500 @enderror" required>
                        @foreach(\App\Models\CampusEquipment::CONDITIONS as $key => $label)
                            <option value="{{ $key }}" {{ old('condition', $equipment->condition) == $key ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="date" name="purchase_date" id="purchase_date" value="{{ old('purchase_date', $equipment->purchase_date?->format('Y-m-d')) }}" class="form-input w-full @error('purchase_date') border-red-500 @enderror">
                    @error('purchase_date')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="purchase_cost" id="purchase_cost" value="{{ old('purchase_cost', $equipment->purchase_cost) }}" step="0.01" min="0" class="form-input w-full @error('purchase_cost') border-red-500 @enderror">
                    @error('purchase_cost')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="current_value" id="current_value" value="{{ old('current_value', $equipment->current_value) }}" step="0.01" min="0" class="form-input w-full @error('current_value') border-red-500 @enderror">
                    @error('current_value')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="last_maintenance_date" id="last_maintenance_date" value="{{ old('last_maintenance_date', $equipment->last_maintenance_date?->format('Y-m-d')) }}" class="form-input w-full @error('last_maintenance_date') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="date" name="next_maintenance_date" id="next_maintenance_date" value="{{ old('next_maintenance_date', $equipment->next_maintenance_date?->format('Y-m-d')) }}" class="form-input w-full @error('next_maintenance_date') border-red-500 @enderror">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="notes" id="notes" rows="3" class="form-textarea w-full @error('notes') border-red-500 @enderror">{{ old('notes', $equipment->notes) }}</textarea>
                    @error('notes')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>

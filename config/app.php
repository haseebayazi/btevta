...
return [
    ...
    */
    ...
    | by the translation service provider. This is used by Eloquent to make
    | pluralization choices, as well as other locale-aware functionality.
    |
    */
    ...
    */
    ...
    | allow you to place the application in maintenance mode via the cache.
    |
    */

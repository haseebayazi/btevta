...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'BTEVTA - Overseas Employment Management'); ?></title>
...
<body class="bg-gray-50" x-data="{ sidebarOpen: true, profileDropdown: false }">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-cloak
                            ...
                            <div class="px-4 py-2 border-b">
                                ...
                                <p class="text-xs text-gray-600"><?php echo e(ucfirst(str_replace('_', ' ', auth()->user()->role))); ?></p>
                            </div>
        ...
        <aside :class="sidebarOpen ? 'w-64' : 'w-20'" 
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" 
                   class="sidebar-item flex items-center space-x-3 px-3 py-2 rounded-lg <?php echo e(request()->routeIs('dashboard') ? 'sidebar-item-active' : ''); ?>">
                ...
                <div class="pt-4">
                    ...
                    <a href="<?php echo e(route('dashboard.candidates-listing')); ?>" 
                       class="sidebar-item flex items-center space-x-3 px-3 py-2 rounded-lg <?php echo e(request()->routeIs('dashboard.candidates-listing') ? 'sidebar-item-active' : ''); ?>">
                        <i class="fas fa-list text-lg w-6"></i>
                        <span x-show="sidebarOpen" class="font-medium">Candidates Listing</span>
                    </a>
                    
                    <!-- Tab 2: Screening -->
                    <a href="<?php echo e(route('dashboard.screening')); ?>" 
                       class="sidebar-item flex items-center space-x-3 px-3 py-2 rounded-lg <?php echo e(request()->routeIs('dashboard.screening') ? 'sidebar-item-active' : ''); ?>">
                        <i class="fas fa-phone text-lg w-6"></i>
                        <span x-show="sidebarOpen" class="font-medium">Screening</span>
                    </a>
                    
                    <!-- Tab 3: Registration -->
                    <a href="<?php echo e(route('dashboard.registration')); ?>" 
                       class="sidebar-item flex items-center space-x-3 px-3 py-2 rounded-lg <?php echo e(request()->routeIs('dashboard.registration') ? 'sidebar-item-active' : ''); ?>">
                        <i class="fas fa-user-check text-lg w-6"></i>
                        <span x-show="sidebarOpen" class="font-medium">Registration</span>
                    </a>
                    
                    <!-- Tab 4: Training -->
                    <a href="<?php echo e(route('dashboard.training')); ?>" 
                       class="sidebar-item flex items-center space-x-3 px-3 py-2 rounded-lg <?php echo e(request()->routeIs('dashboard.training') ? 'sidebar-item-active' : ''); ?>">
                        <i class="fas fa-graduation-cap text-lg w-6"></i>
                        <span x-show="sidebarOpen" class="font-medium">Training</span>
                    </a>
                    
                    <!-- Tab 5: Visa Processing -->
                    <a href="<?php echo e(route('dashboard.visa-processing')); ?>" 
                       class="sidebar-item flex items-center space-x-3 px-3 py-2 rounded-lg <?php echo e(request()->routeIs('dashboard.visa-processing') ? 'sidebar-item-active' : ''); ?>">
                        <i class="fas fa-passport text-lg w-6"></i>
                        <span x-show="sidebarOpen" class="font-medium">Visa Processing</span>
                    </a>
                    
                    <!-- Tab 6: Departure -->
                    <a href="<?php echo e(route('dashboard.departure')); ?>" 
                       class="sidebar-item flex items-center space-x-3 px-3 py-2 rounded-lg <?php echo e(request()->routeIs('dashboard.departure') ? 'sidebar-item-active' : ''); ?>">
                        <i class="fas fa-plane-departure text-lg w-6"></i>
                        <span x-show="sidebarOpen" class="font-medium">Departure</span>
                    </a>
                    
                    <!-- Tab 7: Correspondence -->
                    <a href="<?php echo e(route('dashboard.correspondence')); ?>" 
                       class="sidebar-item flex items-center space-x-3 px-3 py-2 rounded-lg <?php echo e(request()->routeIs('dashboard.correspondence') ? 'sidebar-item-active' : ''); ?>">
                        <i class="fas fa-envelope text-lg w-6"></i>
                        <span x-show="sidebarOpen" class="font-medium">Correspondence</span>
                    </a>
                    
                    <!-- Tab 8: Complaints -->
                    <a href="<?php echo e(route('dashboard.complaints')); ?>" 
                       class="sidebar-item flex items-center space-x-3 px-3 py-2 rounded-lg <?php echo e(request()->routeIs('dashboard.complaints') ? 'sidebar-item-active' : ''); ?>">
                    ...
                    <a href="<?php echo e(route('dashboard.document-archive')); ?>" 
                       class="sidebar-item flex items-center space-x-3 px-3 py-2 rounded-lg <?php echo e(request()->routeIs('dashboard.document-archive') ? 'sidebar-item-active' : ''); ?>">
                        <i class="fas fa-archive text-lg w-6"></i>
                        <span x-show="sidebarOpen" class="font-medium">Documents</span>
                    </a>
                    
                    <!-- Tab 10: Reports -->
                    <a href="<?php echo e(route('dashboard.reports')); ?>" 
                       class="sidebar-item flex items-center space-x-3 px-3 py-2 rounded-lg <?php echo e(request()->routeIs('dashboard.reports') ? 'sidebar-item-active' : ''); ?>">
                ...
                <div class="pt-4 border-t">
                    ...
                    <a href="<?php echo e(route('admin.campuses.index')); ?>" 
                    ...
                    <a href="<?php echo e(route('admin.oeps.index')); ?>" 
                       class="sidebar-item flex items-center space-x-3 px-3 py-2 rounded-lg">
    ...
    <footer :class="sidebarOpen ? 'ml-64' : 'ml-20'" 
        ...
        <p>&copy; <?php echo e(date('Y')); ?> BTEVTA - Board of Technical Education & Vocational Training Authority, Punjab. All rights reserved.</p>
    </footer>
...
</html><?php /**PATH /home/iihsedup/oep.jaamiah.com/resources/views/layouts/app.blade.php ENDPATH**/ ?>
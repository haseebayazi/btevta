...
class UpdateImplementingPartnerRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('update', $this->route('implementing_partner'));
    }
    ...
    {
        $partnerId = $this->route('implementing_partner')->id;

        return [
            'name' => 'required|string|max:255|unique:implementing_partners,name,' . $partnerId,

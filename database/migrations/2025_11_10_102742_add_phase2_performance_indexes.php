...
return new class extends Migration
{
     ...
     * Returns false by default to allow index creation to proceed (will fail gracefully if exists)
     */
    private function indexExists(string $table, string $indexName): bool
    {
        // For SQLite compatibility, we return false and let the index creation
        // be wrapped in try-catch to handle duplicates gracefully
        return false;
    }
};
